const en = {
  ...
  home: {
    ...
    dashboard: {
      ...
      status: "Live",
      metrics: {
        events: "Real-time events collected",
        confidence: "Bias-adjusted confidence",
        speed: "Issue detection speed",
      },
    },
    painGain: {
      eyebrow: "Pain vs Gain",
      title: "Move beyond sample surveys with real-time data",
      description:
        "From asking people to reading behavior. Speed, cost, and representation are rebuilt.",
      headers: {
        criteria: "Criteria",
      ...
      rows: {
        responseRate: {
          label: "Response rate",
          legacy: "Sample responses around 5%",
          casa: "Tens of millions of behavioral signals",
        },
        speed: {
          label: "Speed",
          legacy: "Days from survey design to publication",
          casa: "Real-time issue detection and updates",
        },
        distortion: {
          label: "Distortion",
          legacy: "Non-response and sampling bias risk",
          casa: "AI bias reduction and cross-validation",
        },
        cost: {
          label: "Cost",
          legacy: "High fixed cost per survey",
          casa: "Reusable, lower-cost data infrastructure",
        },
        behavior: {
          label: "Behavioral insight",
          legacy: "Only reflects what people say",
          casa: "Analyzes search, comments, clicks, and behavior signals",
        },
      },
    },
    solution: {
      eyebrow: "Solution",
      title: "An AI public sentiment engine from collection to dashboard",
      description:
        "Collect → refine → analyze → index → dashboard. Public sentiment becomes an operating flow.",
      steps: {
        collection: {
          title: "Data Collection",
          summary: "SNS, news, and search signals",
          text: "Collect SNS, YouTube, news comments, search trends, and community data through APIs and crawling.",
        },
        refinement: {
          title: "Data Refinement",
          summary: "Bots, duplicates, and noise removed",
          text: "Remove profanity, bots, duplicate accounts, and noise while refining regional and contextual signals.",
        },
        analysis: {
          title: "AI Analysis",
          summary: "Sentiment, issues, and influence",
          text: "Analyze sentiment, issues, political influence, and opinion structures with Korean political language models.",
        },
        index: {
          title: "Index Generation",
          summary: "Politica Index generated",
          text: "Convert sentiment into Politica Index, Heat Score, and Momentum to read direction and velocity.",
        },
        dashboard: {
          title: "Real-time Dashboard",
          summary: "Alerts and reports delivered",
          text: "Deliver support trends, daily issues, and negative-sentiment alerts to client dashboards.",
        },
      },
    },
    technology: {
      ...
      cards: {
        nlp: {
          ...
          text: "Classifies positive, negative, and neutral sentiment with context-aware Korean political language models.",
        },
        opinion: {
          title: "Opinion Modeling Engine",
          text: "Analyzes why public sentiment moves, not just how often a keyword is mentioned.",
        },
        predictive: {
          title: "Predictive Analytics",
          text: "Reads the next move through election forecasting and policy response simulations.",
        },
        dashboard: {
          title: "Real-time Dashboard",
          text: "Provides an operating screen where politicians and institutions can detect risk signals immediately.",
        },
      },
    },
    product: {
      eyebrow: "Product",
      title: "Three products for political strategy",
      description:
        "Reports, SaaS, and forecasting models packaged for strategic decisions.",
      cards: {
        insight: {
          title: "Politica Insight",
          audience: "B2B Report",
          text: "Real-time public sentiment reports for parties, lawmakers, and local governments.",
        },
        pulse: {
          title: "Politica Pulse",
          audience: "SaaS Platform",
          text: "A subscription platform for monitoring specific issues and political figures.",
        },
        forecast: {
          title: "Politica Forecast",
          audience: "Prediction Model",
          text: "A premium analytics model for election outcomes and policy response forecasting.",
        },
      },
    },
    insight: {
